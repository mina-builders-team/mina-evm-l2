...
```bash
cd op-succinct
kurtosis run --enclave my-testnet github.com/ethpandaops/optimism-package@452133367b693e3ba22214a6615c86c60a1efd5e --args-file op-network.yaml --image-download always
```
